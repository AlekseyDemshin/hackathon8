...
//generate plugin bundle into /server/output dir
pluginsRouter.post("/templates/:templateName", function (req, res) {
...
//add images to /server/output/img dir
pluginsRouter.post("/templates/:templateName/images", (req, res, next) => {
...
//get zip archive of plugin from /server/output dir
pluginsRouter.get("", (req, res, next) => {
    res.status(200).send();
});
